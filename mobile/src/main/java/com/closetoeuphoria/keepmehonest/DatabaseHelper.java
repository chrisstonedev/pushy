...
import com.closetoeuphoria.keepmehonest.DatabaseContract.Alarm;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private AlarmModel populateModel(Cursor c) {
        ...
        if (!c.getString(c.getColumnIndex(Alarm.COLUMN_NAME_ALARM_TONE)).isEmpty())
    ...
    public int deleteAlarm(long id) {
        return getWritableDatabase().delete(Alarm.TABLE_NAME, Alarm._ID + " = ?",
